...
Каждый пользователь может наследовать глобальные списки или использовать полный
пользовательский override. Администратор отдельно разрешает пользователю
редактировать и включать override через пользовательский интерфейс. Default
routes из фидов всегда отбрасываются, а расширение ограничено для защиты от
случайного взрыва количества префиксов.
