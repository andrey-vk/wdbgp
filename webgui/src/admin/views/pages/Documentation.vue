...
npm install --save-dev @primevue/nuxt-module</code></pre>
    ...
    <p class="text-lg mb-4">
      Add PrimeVue-Nuxt module to <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">nuxt.config.js</span>
    </p>
    <pre class="app-code">
<code>modules: [
    ...
    <p class="text-lg mb-4">
      Install <a
        ...
        class="font-medium text-primary hover:underline"
      >Tailwind CSS</a> with Nuxt using official documentation.
    </p>
...
<code>plugins: [require('tailwindcss-primeui')]</code></pre>
    ...
    <p class="text-lg mb-4">
      Add PrimeVue to in <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">nuxt.config.js</span>
    </p>
    <pre class="app-code">
...
&lt;/template&gt;</code></pre>
    ...
    <p class="text-lg mb-4">
      Create <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">layouts/default.vue</span> and paste this code:
    </p>
    <pre class="app-code">
<code>&lt;script setup&gt;
...
&lt;/template&gt;</code></pre>
    ...
    <pre class="app-code">
<code>import { useLayout } from '@/admin/layout/composables/layout';</code></pre>

    <p class="text-lg mb-4">
      As a final step, copy the following folders:
    </p>
    <ul class="leading-normal list-disc pl-8 text-lg mb-4">
      <li><span class="text-primary font-medium">public/demo</span> <i class="pi pi-arrow-right text-sm! mr-1" /> <span class="text-primary font-medium">public</span></li>
      <li><span class="text-primary font-medium">src/components</span> <i class="pi pi-arrow-right text-sm! mr-1" /> <span class="text-primary font-medium">components</span></li>
      <li><span class="text-primary font-medium">src/service</span> <i class="pi pi-arrow-right text-sm! mr-1" /> <span class="text-primary font-medium">service</span></li>
      <li><span class="text-primary font-medium">src/views/uikit</span> <i class="pi pi-arrow-right text-sm! mr-1" /> <span class="text-primary font-medium">pages/uikit</span></li>
      <li><span class="text-primary font-medium">src/views/pages</span> <i class="pi pi-arrow-right text-sm! mr-1" /> <span class="text-primary font-medium">pages</span></li>
    </ul>
  </div>
</template>
