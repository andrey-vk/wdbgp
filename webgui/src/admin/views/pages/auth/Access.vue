...
import FloatingConfigurator from '@/admin/components/FloatingConfigurator.vue';
</script>
...
<template>
  ...
  <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
    <div class="flex flex-col items-center justify-center">
      <div class="rounded-[56px] p-[0.3rem] bg-[linear-gradient(180deg,rgba(247,149,48,0.4)_10%,rgba(247,149,48,0)_30%)]">
        <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center rounded-[53px]">
          <div class="gap-4 flex flex-col items-center">
            <div
              class="flex justify-center items-center border-2 border-orange-500 rounded-full w-[3.2rem] h-[3.2rem]"
            >
