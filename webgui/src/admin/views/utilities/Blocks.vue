...
<template>
  <div>
    ...
    <BlockViewer
      header="Pricing"
      :code="blocksCode.pricing"
      free
    >
      <div class="bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20">
        <div class="flex flex-col gap-4 items-center justify-center mb-12">
          <div class="text-surface-900 dark:text-surface-0 font-bold text-4xl lg:text-5xl text-center leading-tight">
            Pricing Plans
          </div>
    ...
    <BlockViewer
      ...
      container-class="bg-surface-0 dark:bg-surface-950"
      free
    >
    ...
    <BlockViewer
      ...
      :code="blocksCode['description-list']"
      free
    >
