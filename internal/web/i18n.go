...
var translations = map[locale]map[string]string{
	localeEnglish: {
		...
		"bgp.state.IDLE":             "Idle",
		"bgp.state.CONNECT":          "Connecting",
		"bgp.state.ACTIVE":           "Active",
		"bgp.state.OPENSENT":         "Open Sent",
		"bgp.state.OPENCONFIRM":      "Open Confirm",
		"bgp.state.ESTABLISHED":      "Connected",
		"bgp.state.UNSPECIFIED":      "Unknown",
		"bgp.state.—":                "No BGP session",
		...
		"users.bgp_password_placeholder": "optional",
		"users.dynamic_ip":           "Dynamic IP (0.0.0.0)",
		"users.dynamic_ip_hint":      "Dynamic peers match by ASN and BGP password only. Useful for routers without a fixed address.",
		...
		"users.bgp_section":         "BGP Settings",
		"users.access_section":      "Access Control",
		"users.permissions_section": "Permissions",
		...
		"hints.feed_name":            "A descriptive name for this feed source",
		"hints.feed_url":             "HTTP or HTTPS URL to the feed data",
		"hints.feed_adapter":         "How to parse this feed's data",
		"hints.feed_sync_interval":   "Seconds between syncs, 0 for default",
		"hints.user_name":            "Display name for this BGP peer",
		"hints.user_networks":        "Comma-separated CIDRs identifying this user",
		"hints.user_peer_ip":         "BGP neighbor IP address",
		"hints.user_peer_asn":        "Autonomous System Number",
		"hints.user_next_hop":        "Override the BGP next-hop address (optional, leave empty for auto).",
		"hints.user_catalog_mode":             "Which catalog mode this user sees",
		"hints.user_peer_password_required": "Password is required when sharing this IP address with a different ASN.",
		"hints.mode_name":            "Name for this catalog mode",
		"hints.adapter_name":         "Display name for this adapter",
		"hints.adapter_allowed_hosts": "Additional allowed HTTP hosts, one per line",
		"hints.adapter_source":       "JavaScript adapter code",
	},
	localeRussian: {
		"language.label":             "Язык",
		...
		"bgp.state.IDLE":             "Ожидание",
		"bgp.state.CONNECT":          "Подключение",
		"bgp.state.ACTIVE":           "Активен",
		"bgp.state.OPENSENT":         "Open отправлен",
		"bgp.state.OPENCONFIRM":      "Open подтверждён",
		"bgp.state.ESTABLISHED":      "Подключён",
		"bgp.state.UNSPECIFIED":      "Неизвестно",
		"bgp.state.—":                "Нет BGP-сессии",
		...
		"users.bgp_password_placeholder": "необязательно",
		"users.dynamic_ip":           "Динамический IP (0.0.0.0)",
		"users.dynamic_ip_hint":      "Динамические пиры сопоставляются только по ASN и BGP-паролю. Полезно для маршрутизаторов без фиксированного адреса.",
		...
		"users.bgp_section":         "Настройки BGP",
		"users.access_section":      "Управление доступом",
		"users.permissions_section": "Разрешения",
		...
		"hints.feed_name":            "Описательное имя для этого источника данных",
		"hints.feed_url":             "HTTP или HTTPS URL к данным фида",
		"hints.feed_adapter":         "Как парсить данные этого фида",
		"hints.feed_sync_interval":   "Секунд между синхронизациями, 0 для значения по умолчанию",
		"hints.user_name":            "Отображаемое имя для этого BGP-пира",
		"hints.user_networks":        "CIDR, идентифицирующие этого пользователя, через запятую",
		"hints.user_peer_ip":         "IP-адрес BGP-соседа",
		"hints.user_peer_asn":        "Номер автономной системы",
		"hints.user_next_hop":        "Переопределить BGP next-hop адрес (необязательно, оставьте пустым для auto).",
		"hints.user_catalog_mode":             "Какой режим каталога видит этот пользователь",
		"hints.user_peer_password_required": "Пароль обязателен при использовании этого IP-адреса с другим ASN.",
		"hints.mode_name":            "Название для этого режима каталога",
		"hints.adapter_name":         "Отображаемое имя для этого адаптера",
		"hints.adapter_allowed_hosts": "Дополнительные разрешённые HTTP-хосты, по одному на строку",
		"hints.adapter_source":       "Исходный код JavaScript адаптера",
	},
}
