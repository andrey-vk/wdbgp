...
var translations = map[locale]map[string]string{
	...
	localeRussian: {
		...
		"communities.generate_confirm": "Сгенерировать номера community для всех категорий и сервисов, у которых их нет?",
		"communities.reset_confirm":    "Это сбросит ВСЕ номера community на авто-сгенерированные значения. Ручные изменения будут потеряны. Продолжить?",
		"communities.apply_edit_confirm": "Применить изменения для этого номера community?",
		"communities.duplicate_error":  "Этот номер community уже используется. Выберите другой номер.",
		"communities.changed_one":      "номер community изменён",
		"communities.changed_many":     "номеров community изменено",
